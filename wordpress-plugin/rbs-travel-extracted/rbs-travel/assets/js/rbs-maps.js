...
class rbsMap {
    ...
    parseOptions(options) {
        ...
        if (this.debug) {
            console.log('Debug mode is enabled.');
            console.log('rbsMap Options: ', this.options);
        } 
    }
    ...
    // ?? Move to 'map manager'
    renderImage(mapContainer, targetContainer = null, options = {}) {
        ...
        targetContainer = targetContainer !== null ? targetContainer : mapContainer;
        ...
        leafletImage(this.mapContainer._instance_map, (err, canvas) => {
            console.log('leafletImage', err, canvas, this.mapContainer._instance_map, options);
            ...
            if (err) {
                ...
                if (this.debug) {
                    console.log('leafletImage Error: ', err);
                }
            } else {
                var img = document.createElement('img');
                var dimensions = this.mapContainer._instance_map.getSize();
                ...
                if (typeof options.callback.completed === 'function') {
                    options.callback.completed(canvas);
                }                
            }
            ...
            console.log('leafletImage', options);
