...
jQuery(document).ready(function($){
    ...
    function captionReset() {
        $('.carousel .active').each(function () {
            $(this).find('.carousel-caption h3').animate({marginRight: '25.250em', opacity: '0'}, 200);
            $(this).find('.carousel-caption h6').animate({marginRight: '-25.250em', opacity: '0'}, 200);
        });
    }
    function carouselCustom() {
        $('.carousel .active').each(function () {
            $(this).find('.carousel-caption h3, .carousel-caption h6').animate({marginRight: '0', opacity: '1'}, 400);
