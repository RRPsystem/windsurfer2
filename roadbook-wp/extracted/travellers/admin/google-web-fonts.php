<?php
add_action( 'init', 'travellers_google_fonts_init' );
function travellers_google_fonts_init(){
    $ot_google_fonts_cache_key = 'travellersperchdevelopment';
    $ot_set_google_fonts  = get_theme_mod( 'ot_google_fonts', array() );
    if(empty($ot_set_google_fonts)) return false;

   
    $ot_google_fonts_data = json_decode( trim( travellers_get_google_fonts_array() ), true );
...
function travellers_get_google_fonts_array(){
$travellers_fonts ='{
